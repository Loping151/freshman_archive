...
def render_game(g, model=None, fps=5):
    import pygame
    pygame.init()
...
# run this in cmd(example):
#                                                      white, player2             black, player1, first hand
# python .\Competition_Gobang-main\run_log.py --my_ai "Lo_Gobang_151" --opponent "Lo_Gobang_151_v2"
